...
SELECT id, 'Kjøleskap 1', 1 FROM temperature_zones WHERE zone_type = 'refrigerator' AND NOT EXISTS (SELECT 1 FROM temperature_items WHERE name_no = 'Kjøleskap 1');

INSERT INTO temperature_items (zone_id, name_no, sort_order)
SELECT id, 'Kjøleskap 2', 2 FROM temperature_zones WHERE zone_type = 'refrigerator' AND NOT EXISTS (SELECT 1 FROM temperature_items WHERE name_no = 'Kjøleskap 2');

INSERT INTO temperature_items (zone_id, name_no, sort_order)
SELECT id, 'Kjøleskap 3', 3 FROM temperature_zones WHERE zone_type = 'refrigerator' AND NOT EXISTS (SELECT 1 FROM temperature_items WHERE name_no = 'Kjøleskap 3');

-- Insert sample temperature items for freezers
INSERT INTO temperature_items (zone_id, name_no, sort_order)
SELECT id, 'Fryser 1', 1 FROM temperature_zones WHERE zone_type = 'freezer' AND NOT EXISTS (SELECT 1 FROM temperature_items WHERE name_no = 'Fryser 1');

INSERT INTO temperature_items (zone_id, name_no, sort_order)
SELECT id, 'Fryser 2', 2 FROM temperature_zones WHERE zone_type = 'freezer' AND NOT EXISTS (SELECT 1 FROM temperature_items WHERE name_no = 'Fryser 2');

-- Insert sample temperature items for dishwasher
INSERT INTO temperature_items (zone_id, name_no, sort_order)
SELECT id, 'Oppvaskmaskin hovedkjøkken', 1 FROM temperature_zones WHERE zone_type = 'dishwasher' AND NOT EXISTS (SELECT 1 FROM temperature_items WHERE name_no = 'Oppvaskmaskin hovedkjøkken');

-- Insert sample temperature items for meat serving
INSERT INTO temperature_items (zone_id, name_no, sort_order)
SELECT id, 'Kjøtttermometer 1', 1 FROM temperature_zones WHERE zone_type = 'meat_serving' AND NOT EXISTS (SELECT 1 FROM temperature_items WHERE name_no = 'Kjøtttermometer 1');

INSERT INTO temperature_items (zone_id, name_no, sort_order)
SELECT id, 'Kjøtttermometer 2', 2 FROM temperature_zones WHERE zone_type = 'meat_serving' AND NOT EXISTS (SELECT 1 FROM temperature_items WHERE name_no = 'Kjøtttermometer 2');

-- Insert sample temperature items for receiving
INSERT INTO temperature_items (zone_id, name_no, sort_order)
SELECT id, 'Varemottak termometer', 1 FROM temperature_zones WHERE zone_type = 'receiving' AND NOT EXISTS (SELECT 1 FROM temperature_items WHERE name_no = 'Varemottak termometer');
